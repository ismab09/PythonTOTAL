...
operador = ''
precios_comida = [499,275,525,299,325,450,299,450]
precios_bebida = [85, 85, 95, 95, 95, 150, 175, 200]
precios_postres = [75, 85, 80, 55, 125, 45, 115, 150]
...
def recibo():
    ...
    texto_recibo.insert(END, f'*' * 66 + '\n')
    texto_recibo.insert(END, '¡Lo esperamos!')
...
aplicacion.geometry('1193x630+0+0')
...
# Etiqueta titulo
etigueta_titulo = Label(panel_superior,
                        text='Sistema de Facturación',
                        fg='azure4', font=('Algerian', 50),
                        bg='burlywood', width=25)
etigueta_titulo.grid(row=0, column=0)
...
# Panel de los recibos
panel_recibos = Frame(panel_derecho, bd=1, relief=FLAT,
                          bg='burlywood')
panel_recibos.pack()
...
# Lista de productos
lista_comidas = ['Milanesa','Hamburguesa','Chivito',
                 'Ravioles', 'Lasagna', 'Canelones','Chorizo',
                 'Pizza']
lista_bebidas = ['Agua SG','Agua CG','Fanta','Sprite',
                 'Coca cola','Cerveza P',
                 'Cerveza Z','Whisky']
lista_postres = ['Helado','Flan','Salchichón',
                 'Frutas','Torta',
                 'Alfajor','Budin','Brownie']
